...
class CalendarStripState extends State<CalendarStrip>
  ...
  CalendarStripState(
    ...
    lastDayOfMonth = pop.DateUtils.getLastDayOfMonth(currentDate);
  ...
  int getLastDayOfMonth(rowStartingDay) {
    return pop.DateUtils.getLastDayOfMonth(
  ...
  onPrevRow() {
    ...
    setState(() {
      ...
      widget.onWeekChanged(
          rowStartingDate, rowStartingDate.add(Duration(days: 6)));
    });
  }
